...
class RuntimeActionContext:
    ...
    # skill_group is an operational capability lane, not the concrete action.
    # Examples: flight_core, payload, coordination, generic.
    # Policy Gate can use it for profile-level allow/deny checks without duplicating
    # every action_type rule.
